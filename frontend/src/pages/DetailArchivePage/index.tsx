...
import { ReactComponent as LikeIcon } from '../../asset/common/like.svg';
...
import { ReactComponent as AddArchiveIcon } from '../../asset/common/addArchive.svg';
...
const DetailArchivePage = () => {
    ...
    const [commentMenuActivate, setCommentMenuActivate] = useState<boolean>(false);
    const [tagLists, setTagLists] = useState(`#유광 #무광 #짧은손톱 #긴손톱 #케어`);
            ...
            <ItemControlWrap>
                <ControlDiv>
                    ...
                    <IconDiv
                        ...
                        onClick={() => {
                            setCommentMenuActivate(prevState => prevState === true ? false : true); 
                        }}
                    >
                        <CommentIcon />
                                ...
                                {comments.map((item, index) => (                                    
                                    <Comments>
                                        ...
                                        <CommentsUserInfo>
                                            ...
                                            <CommentsUserCommentText>This is so pretty! I love the colors and the flower detail</CommentsUserCommentText>
                                        </CommentsUserInfo>
                                    </Comments>
                                ))}
